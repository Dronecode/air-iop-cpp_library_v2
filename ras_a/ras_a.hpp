...
enum class MAV_TYPE
{
    ...
    GPS=41, /* GPS | */
    WINCH=42, /* Winch | */
    GENERIC_COMPONENT=43, /* Generic component which implements the generic component attribute discovery and control interface through mavlink parameter exchange. | */
};
